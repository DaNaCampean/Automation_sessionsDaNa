...
public class ticketSalesMonitor {
    ...
    // open on that time or false otherwise.
      //  String readDay = readPurchaseDay();
        ...
        //System.out.println("USER INPUT = " + isOpen(day, readPurchaseTime(userinput)));
        ...
        System.out.println("final price = === " + returnPrice(ticketType, time));
        ...
        registerPurchase(day,returnHour(time),ticketType);
    ...
    public static void registerPurchase (String day, int hour, String ticketType)
    {
        ...
        System.out.println("Your purchase is: Day = " + day + ", Time = " + hour + ", Type = " + ticketType + ", Price = " + returnPrice(ticketType, hour));

    }
    public static double returnPrice(String ticketType, String time)
    {
    ...
    public static boolean isOpen(String day, String time)
    {
        //Create a boolean method called isOpen that will take as parameters the day of the
        // week and the time of the arrival (e.g. hour) and returns true if the local attractions is
        // open on that time or false otherwise.
      ...
      //  System.out.println("programPerDayHourStart = "+programPerDayHourStart);
       ...
       // System.out.println("programPerDayMinEnd = "+ programPerDayMinEnd);
        ...
        if ((ora >= programPerDayHourStart) && (ora < programPerDayHourEnd))
        {
    ...
    public static void interval (String time)
    {
